        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?= $this->getConfig('base_path') ?>/admin/ai-makale-toplu-uret" id="bulkGenerationForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-label">
                                <input type="radio" name="district_option" value="all" checked>
                                <strong>Tüm İlçeler</strong> - Seçili illerin tüm ilçeleri için makale üret
                            </label>
                            <label class="radio-label">
                                <input type="radio" name="district_option" value="none">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="bulk_keyword">Anahtar Kelime <span class="required">*</span></label>
                            <input type="text" name="keyword" id="bulk_keyword" class="form-input" value="lastik servisi" required>
                        </div>

                        <div class="form-group">
                            <label for="bulk_word_count">Kelime Sayısı</label>
                            <select name="word_count" id="bulk_word_count" class="form-input">
                                <option value="400">400-600 kelime</option>
                                <option value="800" selected>800-1000 kelime</option>
                                <option value="1200">1200-1500 kelime</option>
                            </select>
                        </div>
                    </div>
...
.info-box, .warning-box, .estimation-box {
    padding: 16px;
    border-radius: 6px;
    margin-top: 20px;
}
