        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width">
                ...
                <input type="text" id="h1" name="h1" class="form-input"
                    value="<?= htmlspecialchars($city['h1'] ?? '') ?>"
                    placeholder="Örn: <?= htmlspecialchars($city['name']) ?>'da Profesyonel Lastik Tamiri">
            ...
            <div class="form-group full-width">
                ...
                <input type="text" id="meta_title" name="meta_title" class="form-input"
                    value="<?= htmlspecialchars($city['meta_title'] ?? '') ?>">
            ...
            <div class="form-group full-width">
                ...
                <textarea id="meta_description" name="meta_description" class="form-input" rows="2"><?= htmlspecialchars($city['meta_description'] ?? '') ?></textarea>
            ...
            <div class="form-group full-width">
                ...
                <textarea id="page_description" name="page_description" class="form-input" rows="2"><?= htmlspecialchars($city['page_description'] ?? '') ?></textarea>
            ...
            <div class="form-group full-width">
                ...
                <textarea id="content" name="content" class="form-input" rows="10"><?= htmlspecialchars($city['content'] ?? '') ?></textarea>
                            ...
                            <div class="form-grid">
                                <div class="form-group full-width">
                                    ...
                                    <input type="text" name="h2_titles[]" class="form-input"
                                        ...
                                        placeholder="Örn: <?= htmlspecialchars($city['name']) ?> Lastik Tamiri Hizmetleri">
...
<script>
    ...
    document.getElementById('add-h2-section').addEventListener('click', function() {
        ...
        <div class="form-grid">
            <div class="form-group full-width">
                <label>H2 Başlık *</label>
                <input type="text" name="h2_titles[]" class="form-input" placeholder="Örn: <?= htmlspecialchars($city['name']) ?> Lastik Tamiri Hizmetleri">
                <small>Detay sayfa H1'inden farklı olmalı</small>
            </div>
            <div class="form-group full-width">
                <label>Açıklama (1-2 cümle) *</label>
