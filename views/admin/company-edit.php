...
<div class="admin-header">
            <h1>Firma Düzenle</h1>
            <a href="<?= $this->getConfig('base_path') ?>/admin/firmalar" class="btn btn-secondary">← Geri Dön</a>
        </div>

        <div class="form-container">
            <form method="POST" action="<?= $this->getConfig('base_path') ?>/admin/firma-duzenle/<?= $company['id'] ?>" class="standard-form" enctype="multipart/form-data">
                ...
                <div class="alert alert-info">
                    Bu firmaya ait kullanıcı hesabı bulunmamaktadır.
                </div>
                <?php endif; ?>
                ...
                <div class="form-group full-width">
                    <label for="is_approved">
                        <input type="checkbox" id="is_approved" name="is_approved" value="1" <?= $company['is_approved'] ? 'checked' : '' ?>>
                        Firmayı onaylı olarak işaretle
                    </label>
                    <small>Onaylı firmalar sitede görünür olacaktır.</small>
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">💾 Değişiklikleri Kaydet</button>
                    <a href="<?= $this->getConfig('base_path') ?>/admin/firmalar" class="btn btn-secondary">İptal</a>
                </div>
            </form>
        </div>
    </main>
