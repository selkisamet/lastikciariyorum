...
<div class="admin-container">
    <aside class="admin-sidebar" id="adminSidebar">
        <nav class="admin-nav">
            ...
            <a href="<?= $this->getConfig('base_path') ?>/admin/ai-makale-uret" class="admin-nav-link <?= $pageId === 'ai-articles' || $pageId === 'ai-settings' ? 'active' : '' ?>">✨ AI Makale Üret</a>
            <a href="<?= $this->getConfig('base_path') ?>/admin/ai-saglaiycilar" class="admin-nav-link <?= $pageId === 'ai-providers' ? 'active' : '' ?>">🤖 AI Sağlayıcılar</a>
